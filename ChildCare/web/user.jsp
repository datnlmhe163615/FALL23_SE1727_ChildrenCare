<%-- 
    Document   : user
    Created on : Oct 26, 2023, 3:29:36 PM
    Author     : mihxdat
--%>
                                            ...
                                            <c:forEach items="${requestScope.accounts}" var="a">
                                                <tr>
                                                    ...
                                                    <c:if test="${a.role eq 0}">
                                                        <td><p style="color: red;">Manager</p></td>
                                                    </c:if>
                                                    <c:if test="${a.role eq 1}">
                                                        <td>Admin</td>
                                                    </c:if>
                                                    <c:if test="${a.role eq 2}">
                                                        <td>Staff</td>
                                                    </c:if>
                                                    <c:if test="${a.role eq 3}">
                                                        <td>Customer</td>
                                                    </c:if>
                                                    <td>                                                   
                                                        <button type="button" data-toggle="modal" data-target="#modal${a.id}">
                                                            <i class="material-icons" title="Delete">&#xE872;</i>
                                                        </button>                                                                                                                                                                                      
                                                    </td>
                                                    <td>
                                                        <div id="modal${a.id}" class="modal fade">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <form action="action_acc?id=${a.id}&action=delete" method="POST">
                                           ...
                                           <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.accounts}" var="a" varStatus="loop"> 
                                                    <tr>
                                                        <td></td>
                                                        <td>${a.id}<input type="hidden" name="acc_id${loop.index}" value="${a.id}"></td>
                                                        <td>${a.fullname}</td>
                                                        <td>${a.email}</td>
                                                        <c:if test="${a.gender eq true}">
                                                            <td>Male</td>
