...
import Model.ReservationItem_1;
...
public class ReservationDAO extends DBContext.DBContext {
    ...
    public ArrayList<Reservation_1> getReservation(int index) {
        ArrayList<Reservation_1> list = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new Reservation_1(rs.getInt(1), rs.getInt(3), rs.getString(4), rs.getString(5), rs.getBoolean(6), rs.getString(7),
    ...
    public ArrayList<Reservation_1> getReservationDetail(int id) {
        ArrayList<Reservation_1> list = new ArrayList<>();
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new Reservation_1(rs.getInt(1),
                        new ReservationItem_1(rs.getInt(12), rs.getInt(13), rs.getInt(14), rs.getInt(15), rs.getFloat(16), rs.getInt(17), rs.getDate(18), rs.getDate(19)),
                        new Service_2(rs.getInt(21), rs.getString(23), rs.getString(24))));
            }
