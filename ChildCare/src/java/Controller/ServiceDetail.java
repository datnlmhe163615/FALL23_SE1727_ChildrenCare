 ...
 * @author ADMIN
 */
@WebServlet(name = "ServiceDetail", urlPatterns = {"/detail"})
...
//        processRequest(request, response);
        ...
        List<Service> list = d.getAllService();
        request.setAttribute("list", list);
        String sserviceID = request.getParameter("serviceID");
        if (sserviceID != null) {
            int serviceID = Integer.parseInt(sserviceID);
            Service detail = d.getServicebysID(serviceID);
